...
const getStatusChip = (invite) => {
    if (invite.is_used) {
        return <Chip label="Registered" size="small" color="success" sx={{ fontWeight: 600, fontSize: '11px', borderRadius: '8px', px: 0.5 }} />;
    }
    if (invite.is_expired) {
        return <Chip label="Expired" size="small" sx={{ fontWeight: 600, fontSize: '11px', borderRadius: '8px', px: 0.5 }} />;
    }
    return <Chip label="Pending" size="small" color="warning" sx={{ fontWeight: 600, fontSize: '11px', borderRadius: '8px', px: 0.5 }} />;
};
                ...
                >
                    <Grid container spacing={2.5}>
                        ...
                        <Grid item xs={6}>
                            ...
                            <Box sx={{ mt: 0.75 }}>{getStatusChip(selectedInvite)}</Box>
                        </Grid>
                    </Grid>
                </Box>
